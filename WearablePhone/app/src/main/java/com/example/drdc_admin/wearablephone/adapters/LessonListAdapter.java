...
import com.example.drdc_admin.wearablephone.listners.LessonListener;
...
public class LessonListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        lessonImg.setImageResource(lesson.getDrawableID());


        // set onClickListener for the LinearLayout containing title, image, description of the course
        LessonListener lessonListener = new LessonListener(context, lesson.getTitle());
